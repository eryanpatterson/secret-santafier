    ...
    <div className={formDisplay}>        
        <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
            <div className="flex flex-col">    
                ...
                <input className="rounded p-1 text-gray-700 font-semibold focus:outline-green" value={firstName} onChange={(e) => setFirst(e.target.value)} />
            </div>
            <div className="flex flex-col">  
                <label>Last name</label>
                <input className="rounded p-1 text-gray-700 font-semibold focus:outline-green" value={lastName} onChange={(e) => setLast(e.target.value)} />
            </div>
            <div className="flex flex-col">    
                <label>Email</label>
                <input className="rounded p-1 text-gray-700 font-semibold focus:outline-green" value={email} type='email' onChange={(e) => setEmail(e.target.value)} />
